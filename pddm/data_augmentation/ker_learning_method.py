...
class ker_learning:
    ...
    def kaleidoscope_robot(self, param, z_theta, sym_axis = 'y_axis', sym_method = 'y_ker'):
        ...
        if param_len == 3:    
            ...
            # sym_obj_rel_pos
            param[6] = param[3]-param[0]
            param[7] = param[4]-param[1]
            param[8] = param[5]-param[2]

            # set_trace()
            # sym_obj_rot_euler
            theta_a = param[11:14]
            param[11:14] = self.orientation_mat_symmetric_with_rot_plane(theta_a, rot_z_theta, inv_rot_z_theta, i)

            # set_trace()
            # get the obj real velp 
            v_l_a = param[14:17]+param[20:23]
            ...
            param[14:17] -= param[20:23]

            # sym_obj_velr
            theta_a = param[17:20]
            param[17:20] = self.orientation_mat_symmetric_with_rot_plane(theta_a, rot_z_theta, inv_rot_z_theta, i)
            ...
            if  param_len == 31:
                ...
                # 2. rot transform
                theta_a = param[28:31]
                param[28:31] = self.orientation_mat_symmetric_with_rot_plane(theta_a, rot_z_theta, inv_rot_z_theta, i)
    ...
    def sym_plane_compute(self,param,sym_axis,sym_method):
        ...
        if param_len == 3:    #goal & achieved goal
            param[1+i] = self.sym_plane - param[1+i]
            ...
            param[1+i] = self.sym_plane - param[1+i]
            # sym_obj_pos
            param[4+i] = self.sym_plane - param[4+i]
            ...
            param[15+i] = -param[15+i]
            param[21+i] = -param[21+i]
            
            # sym_obj_velr
            param[17-i] = -param[17-i]
            param[19] = -param[19]

            if  param_len == 31:
            # obstacle state
                param[26+i] = self.sym_plane - param[26+i]
                param[28-i] = -param[28-i]
                param[30] = -param[30]
        return param.copy()
